...
cin >> real;
cin >> number;
cout << "The real is: " << setfill('.') << setw(11) << setprecision(4) << real << endl;
...
cin >> character;
cin >> str;
cout << "You entered the string \""<< str << "\" and the character ' << character << "'." << endl;
cout << endl;

cout << "Enter a word and a real number: ";
cin >> str;
cin >> real;
cout << "You entered: \"" << str << "\" and \"" << fixed << setprecision(3) << real << "\"." << endl;
cout << endl;
